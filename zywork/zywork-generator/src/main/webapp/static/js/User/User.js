...
let fieldTitles = {'id':'编号','email':'邮箱','phone':'手机号','accountName':'账户名','password':'密码','salt':'加密盐值','headicon':'头像','nickname':'昵称','gender':'性别','openid':'微信openid','createTime-date':'创建时间','updateTime-date':'更新时间','isActive':'是否激活'};
