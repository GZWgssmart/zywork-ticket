...
window.operateEvents = {
    'click .to-detail': function (e, value, row, index) {
        showRemoteDetailModal('detail-modal', '/tickeorder-detail/detail-modal', row, fieldTitles);
    },
    'click .to-edit': function (e, value, row, index) {
        showRemoteEditModal('edit-modal', '/tickeorder-detail/edit-modal', 'edit-form', row, validateFields());
    },
    'click .to-inactive': function (e, value, row, index) {
        active('/tickeorder-detail/active', row.id, 1, 'data-list', '/tickeorder-detail/pager-cond');
    },
    'click .to-active': function (e, value, row, index) {
        active('/tickeorder-detail/active', row.id, 0, 'data-list', '/tickeorder-detail/pager-cond');
    },
    'click .to-remove': function (e, value, row, index) {
        remove('/tickeorder-detail/remove/' + row.id, 'data-list', '/tickeorder-detail/pager-cond');
    }
};
