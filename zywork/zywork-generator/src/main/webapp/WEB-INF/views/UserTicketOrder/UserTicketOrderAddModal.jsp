...
<div class="form-group">
    <label for="ticketOrderOpenid" class="col-sm-2 control-label">微信openid：</label>
    <div class="col-sm-10">
        <input id="ticketOrderOpenid" name="ticketOrderOpenid" class="form-control" placeholder="请输入微信openid"/>
    </div>
</div>

<div class="form-group">
    <label for="ticketOrderOrderNo" class="col-sm-2 control-label">订单编号：</label>
    <div class="col-sm-10">
        <input id="ticketOrderOrderNo" name="ticketOrderOrderNo" class="form-control" placeholder="请输入订单编号"/>
    </div>
</div>
