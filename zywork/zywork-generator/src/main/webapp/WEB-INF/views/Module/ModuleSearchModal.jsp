...
<div class="modal-body">
    <table id="module-data-list" data-classes="table table-hover text-nowrap" data-toolbar="#module-toolbar"></table>
    ...
    <div id="module-toolbar">
        ...
        <button class="btn btn-primary" onclick="showSearchForm('module-search-form')">
            <i class="fa fa-eye"></i>
            高级搜索
        </button>
        <button type="button" class="btn btn-white" data-dismiss="modal">取消</button>

        <form id="module-search-form" class="row form-horizontal search-form" style="display: none;">
    ...
    <div class="col-sm-8">
        <input id="isActiveSearch" name="isActive" class="form-control" placeholder="请输入是否激活">
            ...
            <div class="col-sm-6 form-group text-right" style="padding-right: 30px;">
                <button type="button" class="btn btn-primary" onclick="doSearch('module-data-list')">
                    <i class="fa fa-search"></i>
                    搜索
                </button>
                <button type="button" class="btn btn-primary" onclick="doSearchAll('module-data-list', 'module-search-form')">
                    <i class="fa fa-search"></i>
                    搜索所有
                </button>
                <button type="button" class="btn btn-primary" onclick="hideSearchForm('module-data-list', 'module-search-form')">
