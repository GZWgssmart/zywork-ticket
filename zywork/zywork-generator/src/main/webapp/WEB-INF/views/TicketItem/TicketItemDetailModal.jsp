...
<div class="col-sm-6 detail-content">
    ...
    <span class="col-sm-8" id="headImgDetail"></span>
</div>

<div class="col-sm-6 detail-content">
    <span class="col-sm-4 row-detail-title">放映时间：</span>
    <span class="col-sm-8" id="playTimeDetail"></span>
</div>

<div class="col-sm-6 detail-content">
    <span class="col-sm-4 row-detail-title">原价：</span>
    <span class="col-sm-8" id="priceDetail"></span>
</div>

<div class="col-sm-6 detail-content">
    <span class="col-sm-4 row-detail-title">优惠价：</span>
    <span class="col-sm-8" id="unitPriceDetail"></span>
</div>

<div class="col-sm-6 detail-content">
    <span class="col-sm-4 row-detail-title">放映地点：</span>
    <span class="col-sm-8" id="addressDetail"></span>
</div>
