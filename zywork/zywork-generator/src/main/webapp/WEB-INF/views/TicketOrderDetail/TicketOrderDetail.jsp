...
<div class="row wrapper wrapper-content animated fadeInRight">
    <div class="col-sm-12">
        ...
        <div id="toolbar">
            <button class="btn btn-primary" onclick="showRemoteAddModal('add-modal', '/tickeorder-detail/add-modal', 'add-form', validateFields())">
            ...
            <div class="btn-group">
              ...
              <ul class="dropdown-menu">
                <li>
                    <a href="javascript:void(0);" onclick="batchActive('/tickeorder-detail/batch-active', 0, 'data-list', '/tickeorder-detail/pager-cond', 'id')">
                        <i class="fa fa-check-square-o text-success"></i><span class="text-success">&nbsp;批量激活</span>
                    </a>
                </li>
                <li>
                    <a href="javascript:void(0);" onclick="batchActive('/tickeorder-detail/batch-active', 1, 'data-list', '/tickeorder-detail/pager-cond', 'id')">
                        <i class="fa fa-minus-square-o text-danger"></i><span class="text-danger">&nbsp;批量冻结</span>
                    </a>
                </li>
                <li>
                    <a href="javascript:void(0);" onclick="batchRemove('/tickeorder-detail/batch-remove', 'data-list', '/tickeorder-detail/pager-cond', 'id')">
...
<script src="<%=path%>/static/js/TicketOrderDetail/TicketOrderDetail.js"></script>
</html>
