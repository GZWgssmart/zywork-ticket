...
<div class="col-sm-6 detail-content">
    <span class="col-sm-4 row-detail-title">权限字符串：</span>
    <span class="col-sm-8" id=permissionDetail></span>
</div>
...
<div class="col-sm-6 detail-content">
    <span class="col-sm-4 row-detail-title">所属模块：</span>
    <span class="col-sm-8" id=moduleIdDetail></span>
</div>
