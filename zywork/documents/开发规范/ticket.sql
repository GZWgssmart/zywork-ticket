...
INSERT INTO `t_role` VALUES (1,'admin',NULL,'2018-07-27 17:02:14',NULL,0);
...
CREATE TABLE `t_ticket_order` (
  ...
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  `play_time_str` varchar(50) DEFAULT NULL COMMENT '演出时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_ticket_order` VALUES (1,1,NULL,'1','1','2018-07-25 17:05:56',NULL,NULL,NULL,'2018-07-25 17:05:56',NULL,NULL);
...
CREATE TABLE `t_ticket_order_detail` (
  ...
  `play_time_str` varchar(45) DEFAULT NULL COMMENT '演出时间',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  `order_no` varchar(100) DEFAULT NULL COMMENT '订单编号',
  PRIMARY KEY (`id`)
...
INSERT INTO `t_ticket_order_detail` VALUES (1,NULL,NULL,'1-1',NULL,'2018-07-25 17:06:18',NULL,'1'),(2,NULL,NULL,'1-2',NULL,'2018-07-25 17:06:18',NULL,'1');
...
INSERT INTO `t_user_role` VALUES (1,1,1,'2018-07-27 17:02:40',0);
